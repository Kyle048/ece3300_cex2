...
// add your code here -- you must use four instances of the full adder "fulladd", defined below
	...
	fulladd addc0(.x(a[1],.y(b[1],.cin(cout0),.sum(result[1],.cout(cout1))
	fulladd addc0(.x(a[2],.y(b[2],.cin(cout1),.sum(result[2],.cout(cout2))
	fulladd addc0(.x(a[3],.y(b[3],.cin(cout2),.sum(result[3],.cout(result[4]))
